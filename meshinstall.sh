...
DownloadAgent() {
  ...
  wget --no-check-certificate $url/meshagents?id=$machineid -O ./meshagent || curl --no-check-certificate -L --output ./meshagent $url/meshagents?id=$machineid
  ...
  then
    ...
    chmod 755 ./meshagent
    wget --no-check-certificate $url/meshsettings?id=$meshid -O ./meshagent.msh || curl --no-check-certificate -L --output ./meshagent.msh $url/meshsettings?id=$meshid
